...
export const createProductSchema = z.object({
  body: z.object({
    ...
    longDescriptionAr: z.string().optional().default(''),
    longDescriptionEn: z.string().optional().default(''),
    ...
    inventory: z.object({
      onHandQuantity: z.coerce.number().min(0).default(0),
      reservedQuantity: z.coerce.number().min(0).default(0).optional(),
...
export const updateProductSchema = z.object({
  ...
  body: z.object({
    ...
    longDescriptionAr: z.string().optional().nullable(),
    ...
    category: z.string().optional().nullable(),
    inventory: z.object({
      onHandQuantity: z.coerce.number().min(0).optional(),
