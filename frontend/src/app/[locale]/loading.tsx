...
/**
 * Ultra-fast, non-blocking navigation indicator.
 * Provides instant feedback during page transitions without blocking the UI
 * or annoying users with a full-screen blackout.
 */
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: '45%',
          animation: 'rawaqaRouteLaser 0.9s cubic-bezier(0.4, 0, 0.2, 1) infinite',
        }}
      />
      <style jsx>{`
        @keyframes rawaqaRouteLaser {
          0% {
            left: -45%;
          }
          100% {
